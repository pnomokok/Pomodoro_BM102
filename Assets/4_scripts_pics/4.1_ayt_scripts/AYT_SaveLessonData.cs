...
public class AYT_SaveLessonData : MonoBehaviour
{
    ...
    public void AYT_SaveData()
    {
        ...
        if (sos1Correct == -1 || sos1Wrong == -1 || sos1Empty == -1 ||
            ...
            fenCorrect == -1 || fenWrong == -1 || fenEmpty == -1) // Kullanýcý sayý yerine harf girdiyse hata mesajý gösterilir.
        {
        ...
        // 65-88. satýrlarda kullanýcýnýn alanýna göre girdiði deðerlerde bir yanlýþlýk olup olmadýðý kontrol edilir. Eðer gerekliyse hata mesajý gösterilir.
        ...
        // 97-111. satýrlarda alýnan doðru deðerlerin atamasý yapýlýr.
    ...
    private int ParseInputField(TMP_InputField inputField) // Bu fonksiyon parametre aldýðý string'i tam sayý olarak döndürür, string boþsa 0 döndürür.
    {
        ...
        else
        {
            ...
            {
                return -1; // Eðer string sayý deðilse -1 döner.
            }
        }
    }
